...
function multiply(a,b){ //eslint-disable-line
  var product = a * b;
  var element = 'The product of ' + a + ' and ' + b + ' is ' + product + '.';
...
function sumArray(testArray){ //eslint-disable-line
  var numbers = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
  console.log(numbers);
  var string = testArray.toString() + ' was passed in as an array of numbers, and ' + numbers + ' is their sum.';
  console.log(string);
...
function multiplyArray(testArray){ //eslint-disable-line
  var numbers = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
  console.log(numbers);
  var string = 'The numbers ' + testArray.toString() + ' have a product of ' + numbers + '.';
  console.log(string);
  return [numbers, string];
}
